...
export const FAMILY_LABEL: Record<string, Record<Lang, string>> = {
  ...
  liao: { en: 'Liao / Khitan', de: 'Liao / Kitan', zh: '辽/契丹' },
  jin: { en: 'Jin (Jurchen)', de: 'Jin (Jurchen)', zh: '金' },
  'western-xia': { en: 'Western Xia', de: 'Westliche Xia', zh: '西夏' },
...
export const CURATED_RELATIONS: CuratedRelation[] = [
  ...
  },
  {
    ...
    b: 'japan',
    overall: {
      en: 'In the 7th century Japan sent missions to Tang China, learning writing, Buddhism, and statecraft. Later centuries brought conflict (Yuan invasions, Imjin War, modern wars) as well as renewed contact.',
      de: 'Im 7. Jahrhundert sandte Japan Gesandtschaften nach Tang-China und lernte Schrift, Buddhismus und Staatskunst. Später gab es Konflikte (Yuan-Invasionen, Imjin-Krieg, moderne Kriege) und neuen Austausch.',
      zh: '7世纪日本遣唐使赴华，学习文字、佛教与典章制度。此后既有元军征日、壬辰战争与近代冲突，也有新的往来。',
    },
    eventIds: [
      'japanese-missions-tang',
      'yuan-invade-japan',
      'imjin-war',
      'sino-japanese-1895',
      'mukden-incident',
  ...
  },
  {
    ...
    eventIds: ['canton-system-1757', 'macartney-1793', 'opium-war', 'second-opium-war', 'yuanmingyuan-1860'],
  },
  {
    a: 'china',
    b: 'russia',
  ...
  },
  {
    ...
    eventIds: ['battle-talas', 'constantinople-1453', 'muhammad'],
  },
  {
    a: 'caliphate',
    b: 'persia',
    overall: {
      en: 'In the 7th century the Arab-Islamic armies conquered the Sasanian Empire. Persian lands became part of the caliphate, while Iranian language and culture continued to shape Islamic civilization.',
      de: 'Im 7. Jahrhundert eroberten arabisch-islamische Heere das Sasanidenreich. Persische Länder wurden Teil des Kalifats; iranische Sprache und Kultur prägten weiterhin die islamische Welt.',
      zh: '7世纪阿拉伯-伊斯兰军队征服萨珊波斯。波斯故地并入哈里发国家，同时伊朗语言与文化继续深刻影响伊斯兰文明。',
    },
    eventIds: ['muslim-conquest-persia', 'muhammad', 'baghdad-house'],
  },
  {
    a: 'byzantium',
    b: 'ottoman',
